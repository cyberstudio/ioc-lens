    ...
    protected createComponent(): HTMLElement {
        ...
        const variants = [
            new PopupComponent({
                ...
                headerContent: this.parseTemplate('<span class="kbq-typography-subheading">IoC Lens</span>'),
                bodyContent: this.parseTemplate(
                    '<span class="kbq-typography-text-normal">Нет данных об объекте</span>'
                ),
            ...
            new PopupComponent({
                ...
                bodyContent: this.parseTemplate(`
                    <div>
                        <h1 class="kbq-typography-subheading">Окно с прокруткой</h1>
                        <span class="kbq-typography-text-normal">
